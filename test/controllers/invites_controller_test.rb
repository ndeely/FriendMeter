...
class InvitesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create invite" do
    assert_difference('Invite.count') do
      post invites_url, params: { invite: { event_id: @invite.event_id, recipient_id: @invite.recipient_id } }
    end
  ...
  test "should update invite" do
    patch invite_url(@invite), params: { invite: { event_id: @invite.event_id, recipient_id: @invite.recipient_id } }
